<div
  class="-mt-16 md:-mt-30 lg:mt-16 flex flex-col sm:w-10/12 xl:w-full xl:flex-row rounded-2xl bg-base-100 shadow-xl"
>
  <div
    class="album-art xl:w-1/2 2xl:w-5/12 aspect-square rounded-t-2xl xl:rounded-s-2xl xl:rounded-e-none"
  />
  <div
    class="w-full text-center lg:text-left xl:w-2/3 2xl:w-7/12 flex flex-col gap-3 items-center xl:items-start justify-center p-7 lg:p-8"
  >
    <h1>Reclamation</h1>
