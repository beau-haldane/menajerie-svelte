...
<style>
  @media only screen and (max-width: 639px) {
    ...
    .outline-01 {
      width: calc(240vw + 12em);
      top: calc(-30vh - 6em);
      background-color: #ca604f;
      z-index: -2;
    }
    .outline-02 {
      width: calc(240vw + 24em);
      top: calc(-30vh - 12em);
      background-color: #e68953;
      z-index: -3;
    }
    .outline-03 {
      width: calc(240vw + 36em);
      top: calc(-30vh - 18em);
  ...
  @media only screen and (min-width: 640px) {
    ...
    .outline-01 {
      width: calc(180vw + 12em);
      top: calc(-30vh - 6em);
      background-color: #ca604f;
      z-index: -2;
    }
    .outline-02 {
      width: calc(180vw + 24em);
      top: calc(-30vh - 12em);
      background-color: #e68953;
      z-index: -3;
    }
    .outline-03 {
      width: calc(180vw + 36em);
      top: calc(-30vh - 18em);
      background-color: #f0ac5d;
      z-index: -4;
    }
  ...
  @media only screen and (min-width: 1024px) {
    ...
    .outline-01 {
      width: calc(120vw + 12em);
      top: calc(-30vh - 6em);
      background-color: #ca604f;
      z-index: -2;
    }
    .outline-02 {
      width: calc(120vw + 24em);
      top: calc(-30vh - 12em);
      background-color: #e68953;
      z-index: -3;
    }
    .outline-03 {
      width: calc(120vw + 36em);
      top: calc(-30vh - 18em);
      background-color: #f0ac5d;
      z-index: -4;
    }
