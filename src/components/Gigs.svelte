...
<div class="w-full items-center flex flex-col gap-20 lg:px-12">
  ...
  <div class="w-full flex flex-col gap-8">
    {#each gigs as gig}
      <div
        class="card w-full bg-secondary py-8 lg:py-0 outline outline-1 shadow-xl"
      >
        <div
        ...
        >
          ...
          >
            ...
            >
              <div
                class="flex flex-col w-1/2 lg:flex-row items-center gap-1 sm:gap-4 md:w-32 lg:w-64"
              >
                <TimeIcon />{gig.date}
                {#if gig.time}<br />
                  {gig.time}
              ...
              <div
                class="flex flex-col w-1/2 lg:flex-row items-center gap-1 sm:gap-4"
              >
                <LocationIcon />
            ...
            <div class="flex md:flex-col gap-4 w-2/12">
              {#if gig.ticket_link}
                <a
                  ...
                  target="_blank"
                  class="btn lg:btn-md text-xl lg:text-lg btn-primary shadow-lg normal-case font-medium"
                  >Buy Tickets</a
                >
              {/if}
              {#if gig.event_link}
