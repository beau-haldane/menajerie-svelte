...
<div class="h-screen w-screen flex flex-col items-center">
  ...
  <div class='curved-bottom-border-hero'></div>
  <div class='curved-bottom-border-hero outline-01'></div>
  <div class='curved-bottom-border-hero outline-02'></div>
  <div class='curved-bottom-border-hero outline-03'></div>
